...
async function loadJogos() {
  ...
  try {
    ...
    jogos.sort(
      (a, b) => new Date(a.data + " " + a.hora) - new Date(b.data + " " + b.hora)
    );
    ...
    jogosGrid.innerHTML = jogos
      ...
      <div class="jogo-card">
        ...
        <div class="jogo-info">
          <div class="jogo-data"><i class="fas fa-calendar"></i> ${formatDate(
            jogo.data
          )} às ${jogo.hora}</div>
        ...
        ${
          isAdminLoggedIn
            ? `<button class="btn btn-secondary" onclick="removeJogo('${jogo.id}')"><i class="fas fa-trash"></i> Remover</button>`
            : ""
        }
      </div>
    `
    ...
    jogosGrid.innerHTML = `<div class="loading"><p>Erro ao carregar jogos.</p></div>`;
  }
}
