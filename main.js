...
const teamPlayers = {
  traquinas: [
    { name: "Salvador Nunes", position: "Avançado", number: 9, photo: "img/players/joao-silva.jpg" },
    { name: "Santiago Nunes", position: "Médio", number: 10, photo: "img/players/pedro-santos.jpg" },
    { name: "Matias Silva", position: "Defesa", number: 4, photo: "img/players/miguel-costa.jpg" },
    { name: "Tomás Páris", position: "Guarda-Redes", number: 1, photo: "img/players/tiago-oliveira.jpg" },
    { name: "António Sampaio", position: "Extremo", number: 7, photo: "img/players/andre-ferreira.jpg" },
    { name: "Martim Ribeiro", position: "Extremo", number: 7, photo: "img/players/andre-ferreira.jpg" },
    { name: "Pedro Siebre", position: "Extremo", number: 7, photo: "img/players/andre-ferreira.jpg" },
    { name: "Jordan Afonso", position: "Extremo", number: 7, photo: "img/players/andre-ferreira.jpg" },
    { name: "Pedro Fernandes", position: "Extremo", number: 7, photo: "img/players/andre-ferreira.jpg" },
    { name: "Valter Barros", position: "Extremo", number: 7, photo: "img/players/andre-ferreira.jpg" },
    { name: "Gonçalo Alves", position: "Defesa", number: 3, photo: "img/players/bruno-almeida.jpg" },
      {
      name: "Equipa Técnica",
      role: "Equipa Técnica",
      nameList: ["Simão Gonçalves", "Filipe Cunha"],
